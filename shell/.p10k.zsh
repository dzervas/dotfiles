# Generated by Powerlevel10k configuration wizard on 2020-08-25 at 16:18 EEST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 28260.
# Wizard options: awesome-fontconfig + powerline + python, small icons, classic,
# unicode, dark, angled separators, sharp heads, flat tails, 1 line, compact, few icons,
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|kubesa|kubeseal|kubeseal-env|kubeval'
